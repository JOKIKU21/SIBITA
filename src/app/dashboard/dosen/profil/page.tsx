...
// ponytail: profil page needs 'use client' for form inputs
import { useState } from "react";
import { DOSEN_PROFILE } from "@/lib/dosen-data";

export default function ProfilDosenPage() {
  const [nama, setNama] = useState(DOSEN_PROFILE.nama);
  const [email, setEmail] = useState(DOSEN_PROFILE.email);
          ...
          <div className="bg-white border border-neutral-border rounded-4 p-6.5">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <div className="text-[13px] text-neutral-muted">Dosen Pembimbing · NIDN {DOSEN_PROFILE.nidn}</div>
                <button
                  type="button"
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[12.5px] font-semibold text-neutral-muted">NIDN</label>
                <input
                  className="bg-neutral-bg border-[1.5px] border-neutral-border rounded-2.25 py-2.75 px-3.5 text-3.5 outline-none transition-[border-color] duration-200 font-sans focus:border-brand-light text-neutral-muted cursor-default"
                  type="text"
                  value={DOSEN_PROFILE.nidn}
                  readOnly
                />
              </div>
              <div className="flex flex-col gap-1.5">
