...
// ponytail: profil super admin with form inputs
import { useState } from "react";
import { SUPERADMIN_PROFILE } from "@/lib/superadmin-data";

export default function ProfilSuperAdminPage() {
  const [nama, setNama] = useState(SUPERADMIN_PROFILE.nama);
  const [email, setEmail] = useState(SUPERADMIN_PROFILE.email);
    ...
    <div className="block">
      <div className="p-7 max-[600px]:p-4">
        <div className="mb-6">
          ...
          <p className="text-3.5 text-neutral-muted">Kelola informasi akun Super Admin.</p>
        </div>
          ...
          <div className="bg-white border border-neutral-border rounded-4 p-6.5">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="relative">
                <div className="w-20 h-20 rounded-full bg-brand flex items-center justify-center text-[32px] overflow-hidden">
                  👑
                </div>
              ...
              <div>
                ...
                <div className="text-[13px] text-neutral-muted">Administrator Utama Sistem SIBITA</div>
                <button
                  type="button"
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-[12.5px] font-semibold text-neutral-muted">Nama</label>
                <input
