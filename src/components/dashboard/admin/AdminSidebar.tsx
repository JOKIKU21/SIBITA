...
export function AdminSidebar() {
  ...
  const isManajemenActive = pathname.startsWith("/dashboard/admin/manajemen-dosen");
  ...
  return (
    <aside className="w-65 shrink-0 bg-brand-dark flex flex-col p-0 sticky top-0 h-screen overflow-y-auto max-[600px]:hidden">
      ...
      <nav className="pt-4.5 px-3 pb-0 flex-1">
        ...
        <Link href="/dashboard/admin/manajemen-dosen" className={linkClass(isManajemenActive)}>
